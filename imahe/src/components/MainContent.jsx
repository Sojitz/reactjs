...
function MainContent() {
  ...
  return (
    <>
      ...
      <main
        className="relative flex flex-col md:flex-row items-center justify-between p-8  min-h-screen overflow-hidden"
        style={{
      ...
      >
        <div className="md:w-1/2 z-10 p-8 md:p-12 lg:p-16">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0D9488] leading-tight mt-[-100px] mb-4">
            Welcome to <span className="text-[#0D9488]">Imahe</span>
          </h1>
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#6F879F] hover:bg-stone-800 text-white px-6 py-3 rounded-lg transition-colors duration-300 text-lg font-medium"
          >
            Upload Your First Image Today
            <svg
